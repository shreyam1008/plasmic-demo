...
import * as sty from "./PlasmicIconLink.module.css"; // plasmic-import: G2glP2_bRvnza/css
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <svg
              className={classNames(defaultcss.all, sty.svg__jl1QN)}
              role={"img"}
            />
          ),
