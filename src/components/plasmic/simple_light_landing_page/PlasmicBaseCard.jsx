...
import * as sty from "./PlasmicBaseCard.module.css"; // plasmic-import: CAE4Ssxzp-QbsW/css
...
function PlasmicBaseCard__RenderFunc(props) {
  ...
  return (
    ...
    >
      <div
        className={classNames(defaultcss.all, sty.box__sYBzb, {
          [sty.box__long__sYBzbcKiRs]: hasVariant(variants, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      {(hasVariant(variants, "long", "long") ? true : false) ? (
        <div
          className={classNames(defaultcss.all, sty.box__vARk, {
            [sty.box__long__vARkcKiRs]: hasVariant(variants, "long", "long")
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(defaultcss.all, sty.svg___9M9Zk)}
                role={"img"}
              />
            ),
