...
import * as sty from "./PlasmicFaq.module.css"; // plasmic-import: QTLB5MjVobv2Gk/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box___4SnDj)}
      >
        <div className={classNames(defaultcss.all, sty.box__sNjgZ)}>
          <div className={classNames(defaultcss.all, sty.box__sSodJ)}>
            {p.renderPlasmicSlot({
